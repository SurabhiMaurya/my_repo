# -*- coding: utf-8 -*-
"""
Created on Sun Jun 24 04:27:53 2018
...
browser = webdriver.Chrome('C:\Users\surbhi\Downloads\chromedriver_win32\chromedriver.exe')
browser.get(url)
...
#hole div class name through data wiil scraped
...
lst=[url1,url2,url3,url4,url5,url6]
...
#make column area by randomly numbers 
import random as rm 
lst1=[]
for i in range(56):
...
# recreating a csv file
data2.to_csv('data2.csv')

#making same col of all csv for merging/concat
import pandas as pd
...
#concatination of all data frames
frames=[data1,data2,data3]
data=pd.concat(frames)

#calculating area_per_sq_feetS
data['Area_Per_Sqft']=data['Price']/data['Area_Sqft']

#data=data.sort_values(["BHK"])
# FINAL CLEAN DATA..final csv file to perform operation nd convert to csv file
