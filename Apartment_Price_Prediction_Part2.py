# -*- coding: utf-8 -*-
"""
Created on Wed Jun 27 22:48:00 2018
...
#spliting into dep and indep
features=data.iloc[:,0:-1].values
labels=data.iloc[:,-1].values

#label encoding for categorical data to convert into numeric value
...
#for dummy trap means remove one column
features=features[:,1:]
...
plt.bar(lst, area_per_sqft, align='center',color=['g','r','b','y','m'])
plt.xticks(lst, hot_locations,rotation=80)
plt.title("Locality Vs Area/sqft",fontsize=15)
plt.xlabel("Locality",fontsize=15)
plt.ylabel("Area/sqft",fontsize=15)
plt.show()
